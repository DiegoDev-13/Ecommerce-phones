        ...
        {/* LISTA DE PRODUCTOS AÑADIDOS AL CARRITO */}
        {
          ...
          ? (<>
              ...
              <div className="mt-4 p-7">
                ...
                <button onClick={cleanCart} className="mt-3 w-full text-black border border-black rounded-full py-3 cursor-pointer">
                  Limpiar Carrito
                </button>
              </div>
            </>)
          : (<div className="h-screen flex flex-col items-center justify-center gap-7">
              ...
              <Link to='/celulares' className="p-4 bg-black rounded-full text-white px-7 text-xs uppercase tracking-widest font-semibold" onClick={closeSheet}>
                Empezar a comprar
              </Link>
            </div> )
        }
