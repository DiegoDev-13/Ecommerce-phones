  ...
  return (
    <div className="relative bg-gray-900 text-white">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center py-20 px-4 text-center lg:py-40 lg:px-8">
            ...
            <Link to='/celulares' className="bg-gray-900 hover:bg-gray-950 text-white font-semibold py-3 px-6 rounded-lg shadow-lg transition-all duration-300 ease-in-out">
                Ver celulares
            </Link>
        </div>
    </div>
